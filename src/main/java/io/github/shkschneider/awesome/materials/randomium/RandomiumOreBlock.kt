...
abstract class RandomiumOreBlock(val id: String) : OreBlock(
    ...
    override fun onBreak(world: World, pos: BlockPos, state: BlockState, player: PlayerEntity) {
        ...
        player.lookAt(EntityAnchorArgumentType.EntityAnchor.EYES, Vec3d(pos.x.toDouble(), pos.y.toDouble(), pos.z.toDouble()))
    }

    // Similar to net.minecraft.block.RedstoneOreBlock.class
    private fun particles(world: World, pos: BlockPos) {
        ...
        for (direction in directions) {
            ...
            if (!world.getBlockState(blockPos).isOpaqueFullCube(world, blockPos)) {
                ...
                world.addParticle(DustParticleEffect(Vec3f(Vec3d.unpackRgb(color)), 1.0F), pos.x.toDouble() + e, pos.y.toDouble() + f, pos.z.toDouble() + g, 0.0, 0.0, 0.0)
            }
        }
    }
